...
docker exec -w /tmp/jans/jans-config-api docker-jans-monolith-jans-1 mvn -Dcfg="$JANS_FQDN" -Dtest=io.jans.configapi.JenkinsTestRunner -Dmaven.test.skip=false test
